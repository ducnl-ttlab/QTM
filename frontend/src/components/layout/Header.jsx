...
import { SearchIcon, MenuIcon, AccountCircleIcon, AccountBoxIcon, LogoutIcon, SettingsIcon, NotificationsIcon, HomeIcon, BooksIcon } from "../common/icons";
import Toast from "../common/toast";
import showToast from "../../dummydata/toast";
import context from "../../service/authUser";
...
function Header({ user }) {
    ...
    const person = (
        <Wrap onClick={menuToggle}>
            <div className="wrap">
                <div className="profile">{!info.imageUrl ? <AccountCircleIcon className="p-0 font-normal" /> : <img src={`${info.imageUrl}`}></img>}</div>
                                          ...
                                          <button
                                              ...
                                              onClick={(e) => {
                                                  NotificationService.delNotification(v.id)
                                                      .then((data) => {
                                                          setNotificationList([showToast("success", "Thông báo", "Từ chối học sinh")]);
                                                      ...
                                                      .catch((error) => {
                                                          ...
                                                          setNotificationList([showToast("danger", "Thông báo", "Thất bại")]);
                                                      });
                                              }}
                                          >
                                              Từ Chối
